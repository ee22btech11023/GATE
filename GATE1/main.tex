...
\end{align}
Using Equation \ref{eq:Relation}, we get:
\begin{align}
\mathrm{E}[\hat{\sigma}^2_1] &= \sigma_0^2 \\
\mathrm{E}[\hat{\sigma}^2_2] &= \frac{10000}{9999} \sigma_0^2
\end{align}
Hence, the correct answer is \ref{eq:Option3}
\begin{figure}[ht]
\includegraphics[width=\columnwidth]{./figs/Figure.png}
\caption{Scatter plot of $\hat{\sigma}^2_1$ and $\hat{\sigma}^2_2$ vs $\sigma_0^2$}
\label{fig:EE.25.2023}
\end{figure}
\end{document}
